...
\keywords{classificació de plantes, malalties de les plantes, aprenentatge profund, MobileNetV2, visió per computador}
...
PlantAID és un sistema per recollir, etiquetar i classificar imatges de fulles de plantes sanes i malaltes mitjançant l'aprenentatge profund. Aquest article documenta el problema, la solució proposada, l'arquitectura del programari, els experiments realitzats i l'evaluació dels resultats.
\end{abstract}
