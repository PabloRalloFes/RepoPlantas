...
if __name__ == "__main__":
    ...
    def main(page: ft.Page):
        ...
        # Función auxiliar para descargar imágenes en móvil
        def descargar_imagen_multiplataforma(url_imagen):
            """Abre la imagen en el navegador/galería del móvil para guardarla"""
            try:
                parsed = urllib.parse.urlparse(url_imagen)
                query_params = dict(urllib.parse.parse_qsl(parsed.query, keep_blank_values=True))
                if logica_app.token:
                    query_params["access_token"] = logica_app.token
                url_con_token = urllib.parse.urlunparse(
                    parsed._replace(query=urllib.parse.urlencode(query_params))
                )

                # Abrir la URL en la app por defecto (navegador o galería)
                page.launch_url(url_con_token)
                return True, "Abriendo imagen"
        ...
        buscar_usuario_rol_admin = ft.Dropdown(
            label="Seleccionar rol",
            value=None,
            width=320,
            options=[
                ft.dropdown.Option(key=None, text="Cualquiera"),
                ft.dropdown.Option(key="usuario", text="Usuario"),
                ft.dropdown.Option(key="etiquetador", text="Etiquetador"),
        ...
        def buscar_usuarios(nombre: str = None, rol: str= None):
            nombre_filtrado = nombre.strip() if isinstance(nombre, str) else nombre
            if nombre_filtrado == "":
                nombre_filtrado = None

            rol_filtrado = rol
            if isinstance(rol_filtrado, str):
                rol_filtrado = rol_filtrado.strip()
            if rol_filtrado in (None, "", "Cualquiera"):
                rol_filtrado = None

            logica_app.buscar_usuarios(nombre_filtrado, rol_filtrado)
        ...
        def avanzar_imagenes(reverso=False):
            if logica_app.avanzar_puntero_repo(reverso):
                ...
                # volver al último bloque válido.
        ...
        def seleccionar_foto_desde_galeria(file_picker: ft.FilePicker):
        ...
        def route_change(route):
                    ...
                    ft.View(
                        ...
                        [
                            ...
                            ft.Column(
                                ...
                                controls=[
                                    ft.Divider(),
                                    ft.Text("CONFIGURACIÓN DE CONEXIÓN", size=20, weight=ft.FontWeight.BOLD),
                                    ft.Divider(),
                                    ft.Column(
                                        alignment=ft.MainAxisAlignment.CENTER,
                                        horizontal_alignment=ft.CrossAxisAlignment.CENTER,
                                        ...
                                        controls=[
                                            ft.Container(
                                                content=ft.Column(
                                                    ...
                                                    spacing=15,
                                                    controls=[
                                                        ft.Text("Introduce la IP o dominio del servidor Flask:", size=16),
                                                        url_input,
                                                        ft.ElevatedButton(
                                                            text="Guardar",
                                                            bgcolor=ft.Colors.GREEN,
                                            ...
                                            ft.Container(
                                                content=ft.Column(
                                                    ...
                                                    spacing=15,
                                                    controls=[
                                                        ft.Text("Introduce la URL de la base de datos MongoDB:", size=16),
                                                        bbdd_url_input,
                                                        ft.ElevatedButton(
                                                            text="Guardar",
                                                            bgcolor=ft.Colors.GREEN,
            ...
            if page.route == "/main_admin/entrenamientos":
                ...
                for solicitud in solicitudes:
                    ...
                    # Checkbox para que el admin decida
            ...
            if page.route == "/main_etiquetador/filtros":
                ...
                dropdown_planta.width = 320
                dropdown_enfermedad.width = 320
                dropdown_formato.width = 320
                dropdown_fuente.width = 320
                dropdown_num_imagenes.width = 320
                            ...
                            ft.Row(
                                ...
                                controls=[
                                    ft.Column(
                                        ...
                                        controls=[
                                            ft.Divider(),
                                            ft.Text("FILTROS", size=20, weight=ft.FontWeight.BOLD, color=ft.Colors.WHITE),
                                            ft.Divider(),
            ...
            if page.route.startswith("/main_etiquetador/seleccion_imagenes/etiquetar"):
                ...
                imagen_ampliada = ft.Image(width=350, height=400, fit=ft.ImageFit.CONTAIN)
                                                        ...
                                                        content=ft.Column(
                                                            ...
                                                            controls=[
                                                                ...
                                                                ft.ElevatedButton(
                                                                    ...
                                                                    bgcolor=ft.Colors.GREEN,
                                                                    width=280,
                                                                    on_click=lambda _: seleccionar_foto_desde_galeria(file_picker)
                                                                ),
                                                            ]
                                                        )
                                                    ),
                                    ...
                                    ft.Container(
                                        ...
                                        content=ft.Column(
                                            ...
                                            controls=[
                                                ft.Image(
                                                    src_base64=logica_app.foto_b64,
                                                    width=min(280, page.width * 0.7),
                                                    height=min(280, page.width * 0.7),
                                                    fit=ft.ImageFit.CONTAIN,
                                                ),
                                                dropdown_planta,
                                            ],
                        ...
                        ft.View(
                            ...
                            [
                                ...
                                ft.Column(
                                    ...
                                    controls=[
                                        ft.Divider(),
                                        ft.Text("SUBIDA MASIVA DE IMÁGENES", size=20, weight=ft.FontWeight.BOLD),
                                        ft.Divider(),
                                        #ft.Container(height=10),
                                        ft.Container(
                                        ...
                                        # Botón Ejecutar Subida centrado
                                        ft.Container(
                                            padding=10,
                            ...
                            ft.Row(
                                ...
                                controls=[
                                    ...
                                    ft.Column(
                                        ...
                                        spacing=20,
                                        controls=[
                                            # Filtros de datos (arriba en móvil)
                                            ft.Container(
                                                width=350,
                                                padding=20,
                                                border_radius=15,
                                                        ...
                                                        ft.Row(
                                                            ...
                                                            controls=[
                                                                ...
                                                                ft.Container(
                                                                    expand=True,
                                                                    content=ft.Text(
                                                                        "Quiero que este modelo esté disponible para predecir",
                                                                        size=14,
                                                                        color=ft.Colors.WHITE,
                                                                    )
                                                                ),
            ...
            if page.route == "/main_usuario/experimentos/comparar":
                            ...
                            ft.Row(
                                ...
                                controls=[
                                    ft.Column(
                                        ...
                                        controls=[
                                    ft.Divider(),
                                    ft.Text("COMPARAR EXPERIMENTOS", size=20, weight=ft.FontWeight.BOLD),
                                    ft.Divider(),
                                    ft.Text(
                ...
                def descargar_imagen(e):
                    ...
                    if imagen_ampliada_url_original:
                        ...
                        def descargar_en_background():
                            exitoso, resultado = descargar_imagen_multiplataforma(imagen_ampliada_url_original)
                        ...
                        threading.Thread(target=descargar_en_background, daemon=True).start()
                                ...
                                ft.Row(
                                    ...
                                    controls=[
                                        ft.Column(
                                            ...
                                            controls=[
                                                ft.Divider(),
                                                ft.Text("GRÁFICOS DE LA COMPARACIÓN", size=18, weight=ft.FontWeight.BOLD, color=ft.Colors.WHITE),
                                                ft.Divider(),
                                                *filas,
                                            ],
                                        ),
                ...
                if resultados.get("resultados"):
                    ...
                    controles_resultados.append(ft.Container(height=10))
                    ...
                    # Añadir imágenes verticalmente para móvil
                    for i in range(0, len(archivos_base64)):
                        controles_resultados.append(
                            ft.GestureDetector(
                                content=ft.Container(
                                    width=min(page.width * 0.9, 360),
                                    padding=10,
                                    border=ft.border.all(2, ft.Colors.GREEN_200),
                                    border_radius=10,
                                    bgcolor=ft.Colors.WHITE,
                                    ...
                                    content=ft.Stack(
                                        controls=[
                                            ft.Image(
                                                src_base64=archivos_base64[i],
                                                width=min(page.width * 0.8, 340),
                                                height=280,
                                                fit=ft.ImageFit.CONTAIN,
                                            ),
                                            ft.Container(
                                ...
                                on_tap=lambda e, img_b64=archivos_base64[i], url=logica_app.get_url_imagen_resultado(nombre_experimento, archivos[i]): mostrar_imagen_ampliada_base64(img_b64, url),
                            )
                        )
                        controles_resultados.append(ft.Container(height=15))
                    
                    controles_resultados.append(ft.Container(height=20))
                else:
                    controles_resultados.append(
